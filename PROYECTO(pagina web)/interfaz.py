...
def classify_text(entrada):
    client = anthropic.Anthropic(api_key="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")
    ...
    def run(self):
        try:
            ...
            for page in range(num_pages):
                ...
                # Print classified data for debugging
                print(classified_data)
                
                # Assume classified_data is a string for now, further processing may be needed
                nombre = classified_data  # Modify this as per the actual structure of classified_data
                
                # Insertar datos en la base de datos
                insert_text_query = f"""
                INSERT INTO pdf_data (file_name, page_number, nombre)
                VALUES ('{self.pdf_path}', {page}, "{nombre}")
                """
